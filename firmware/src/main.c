...
/**
 * @brief Struct Pointer for RCC Peripherals assigned with fixed address specified in reference
 *manual
 **/
RCC_t *const RCC = (RCC_t *)0x40023800;
/**
 * @brief Struct Pointer for GPIOA Peripherals assigned with fixed address specified in reference
 *manual
 **/
 ...
 *
 *In this implementation the inner for loop, cycles for 1600 CLK Cycles which results in around 1ms
 *delay, depending on the parameter <time>, the amount of ms delay can be adjusted.
 *
